...
//        
//        //Grammar
//        Grammar gramatica_chida = new Grammar(rules, epsilon, S);
...
//            HashMap<GrammarNoTerminal, HashSet<GrammarTerminal>> primeros = GrammarFirstsGenerator.getAllFirsts(my_grammar);
//            HashMap<GrammarNoTerminal, HashSet<GrammarTerminal>> siguientes = GrammarNextsGenerator.getAllNexts(my_grammar);
            HashMap<GrammarRule, HashSet<GrammarTerminal>> predicciones = GrammarPredictionGenerator.getAllPredictions(my_grammar);
